...
- run registered PaddleOCR-VL, Chandra OCR 2, NuExtract3, Tesseract + Table Transformer, RapidOCR + Docling TableFormer, Granite Vision 4.1 4B, TRivia-3B, GLM-OCR, Dolphin-v2, DeepSeek-OCR-2, Nanonets-OCR-s, and MonkeyOCRv2-B-Parsing adapters on already-isolated MinerU table crops
- preserve adapter-native evidence such as PaddleOCR result views, Chandra generated HTML, NuExtract3 generated Markdown, Tesseract OCR tokens, TATR structure output, RapidOCR/Docling native structure evidence, Granite model/OTSL evidence, TRivia raw OTSL evidence, GLM-OCR raw/clean HTML evidence, Dolphin-v2 model HTML/provenance evidence, DeepSeek-OCR-2 grounding/model-output evidence, Nanonets-OCR-s raw/clean HTML evidence, and MonkeyOCRv2-B-Parsing raw OTSL evidence
