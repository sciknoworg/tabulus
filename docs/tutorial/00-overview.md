...
The crop-consuming reconstruction adapters currently registered in the rebuilt library are PaddleOCR-VL, Chandra OCR 2, and NuExtract3. Each adapter receives the same canonical MinerU crop; adapters must not independently locate or recrop tables from the source PDF for the reconstruction comparison.
...
- registered PaddleOCR-VL, Chandra OCR 2, and NuExtract3 reconstruction adapters
- shared HTML/Markdown table parsing and structural normalization during reconstruction
